...
Se o tamano do campo de 16 bits for <= 1500 (05DC) ele expressa ***length***, sendo IEEE 802.3, e se for > 1500 ele expressa ***EtherType***, sendo Ethernet II.

**Regra prática:** Hoje em dia Ethernet II é mais comum em LAN corporativa/Internet, mas o termo "802.3" continua sendo usado para falar do "Padrão Ethernet" como um todo.

**Exemplo de quadro Ethernet:** ![[exemplo_quadro_ethernet.png]]
***OBS:** Preâmbulo e SFD fazem parte da camada física.*
***OBS2:** O tamanho minimo de dados em um quadro é 46 bytes e o máximo de dados é 1500 bytes. Se dados < 46 bytes, o campo será completado com padding.*
