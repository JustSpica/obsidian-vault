...
*OBS: Preâmbulo (sequência de bits para sincronizar o receptor) e SFD (byte que marca o inicio do quadro lógico ethernet) fazem parte da camada física e não da camada de enlace.*
