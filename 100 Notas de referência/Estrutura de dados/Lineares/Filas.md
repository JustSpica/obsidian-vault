...
Fila é uma estrutura de dados linear que segue o princípio **FIFO (First-In, Last-Out)**, onde o primeiro elemento que é adicionado na estrutura é o primeiro elemento que é removido ou processado.
...
- **Fila Dupla (Dequeue):** Em uma *dequeue*, as operações de adicionar e remover um elemento podem ser realizadas em ambas as extremidades. Além disso elas podem ter restrições como:
    - ***Input Restricted***: Só pode adicionar por um dos lados da fila, mas pode remover por ambos os lados.
    - ***Output Restricted*** Só pode remover por um dos lados da fila, mas pode adicionar por ambos os lados.
...
Filas de prioridade possuem dois tipos de ordenação, sendo eles ***Ascending Order*** (onde elementos com valores menores tem maior prioridade) e ***Descending Order*** (onde elementos com valores maiores tem maior prioridade).
