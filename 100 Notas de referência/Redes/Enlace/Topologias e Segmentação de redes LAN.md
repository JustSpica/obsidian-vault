...
Tanenbaum explica que, quando dois dispositivos transmitem simultaneamente, ocorre colisão. Com CSMA/CD, um dispositivo escuta o canal e, se ele estiver livre, pode transmitir. Durante a transmissão, ele monitora para detectar colisão e se detectar colisão ele interrompe a transmissão, espera um tempo aleatório através do algoritmo de **recuo binário exponencial** e tenta enviar novamente.
## HUBs, Bridges e Switches

- **HUBs:** É um equipamento antigo. Todas as suas portas formam um mesmo domínio de broadcast/colisão.
...
- **Switches:** Inicialmente é um Bridge, com mais portas onde cada porta é um domínio de colisão.
...
*OBS: HUBs no geral operam na [[Modelos OSI e TCP IP|camada física]] enquanto Bridges e Switches operam na [[Modelos OSI e TCP IP|camada de enlace]].*
